...
from networks.utils import augment, samplewise_loss, data2tensor, normlize_loss, predict_batchwise
...
preds = predict_batchwise(mopdel, cifar10_augmented)
print(preds)
